...
class Login
{
    ...
    const INVALID_CREDENTIAL = 'invalidCredential'; const INVALID_USER = 'invalidUser';
    ...
    */
    ...
    { 
        $this->authAdapter = new AuthAdapter($dbAdapter,'usuarios',  'email', 'clave');
    ...
    public function login($nick, $password) 
    {
        ...
        {
            $this->authAdapter->setIdentity($nick); $this->authAdapter->setCredential($password);
            ...
            switch ($result->getCode()) 
            {
                ...
                case Result::FAILURE_CREDENTIAL_INVALID:
                    throw new \Exception($this->_messages[self::INVALID_CREDENTIAL]); break;
    ...
    * @param string $messageKey OPTIONAL * @return UserModel
    * @throws Exception
    */

    public function setMessage($messageString, $messageKey = null) { if ($messageKey === null) 
    {
    ...
    /**
    * @param array $messages * @return UserModel
    */
